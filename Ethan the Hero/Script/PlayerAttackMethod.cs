		...
		private void BasicAttackCombo()
{
    ...
    if (Input.GetButtonDown("Fire1") && !myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack01") && !myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack02") && !myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack03") && playerMv.grounded)
    ...
    if (myAnim.GetCurrentAnimatorStateInfo(0).IsName("Attack01"))
    {
        ...
        // Set if attack 01 animation is ended playing and attack button is clicked while attack 01 animation is playing
        ...
        // Set if attack 01 animation is ended playing and attack button is not clicked while attack 01 animation is playing
